...
(() => {
  ...
  function formatNominatimAddress(full) {
    ...
    // Suche Stra�e und Hausnummer VOR der PLZ
    let street = null;
    let number = null;
    ...
    if (street && number) {
      ...
      // Kein Stra�enname erkannt, nimm 1-2 Teile vor PLZ
